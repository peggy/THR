...
public class class_login : System.Web.UI.Page
{
    ...
    public void record_extension_log(string type,string str)
    {
        ...
        {
            path = "C:\\Users\\peggy.liou\\Documents\\VS\\測試區\\HR\\file\\record_extension_log.txt";
        }
        else if (type == "extension_user_log") //匯出Excel
        {
            path = "C:\\Users\\peggy.liou\\Documents\\VS\\測試區\\HR\\file\\record_extension_user_log.txt";
        }
        else if (type == "extension_load_log") //載入分機表
        {
            path = "C:\\Users\\peggy.liou\\Documents\\VS\\測試區\\HR\\file\\record_extension_load_log.txt";
        }
